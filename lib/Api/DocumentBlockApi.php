...
class DocumentBlockApi
{
     ...
     */
    public function listDocumentBlock($page = null, $per_page = '25')
    {
        list($response) = $this->listDocumentBlockWithHttpInfo($page, $per_page);
        return $response;
    }
     ...
     */
    public function listDocumentBlockWithHttpInfo($page = null, $per_page = '25')
    {
        $returnType = '\Swagger\Client\Model\DocumentBlockList';
        $request = $this->listDocumentBlockRequest($page, $per_page);
     ...
     */
    public function listDocumentBlockAsync($page = null, $per_page = '25')
    {
        return $this->listDocumentBlockAsyncWithHttpInfo($page, $per_page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listDocumentBlockAsyncWithHttpInfo($page = null, $per_page = '25')
    {
        $returnType = '\Swagger\Client\Model\DocumentBlockList';
        $request = $this->listDocumentBlockRequest($page, $per_page);
     ...
     */
    protected function listDocumentBlockRequest($page = null, $per_page = '25')
    {
